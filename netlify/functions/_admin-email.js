  ...
  const definitions = {
    welcome: {
      ...
      paragraphs: [
        ...
        'Password-Encrypt does not keep a readable server-side copy of your master password, so support cannot recover or reset it. Emergency Backup Codes, if deliberately generated by the customer, protect a separate encrypted recovery copy; Secure device unlock, if enabled, keeps a separately protected wrapped copy only on that device.'
      ]
    },
    payment_attention: {
