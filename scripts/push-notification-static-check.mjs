...
check('Ver-1.024.02 app/server/package/service-worker versions align', pkg.version === '1.24.2' && /Password-Encrypt Ver-1\.024/.test(main) && /Password-Encrypt Ver-1\.024/.test(db) && /my-passwords-v1\.024/.test(sw));
