...
check('Ver-1.010.03 app/server/package/service-worker versions align', pkg.version === '1.10.3' && /Password-Encrypt Ver-1\.010\.03/.test(main) && /Password-Encrypt Ver-1\.010\.03/.test(db) && /my-passwords-v1\.010\.03/.test(sw));
