...
check('Ver-1.027 app/server/package/service-worker versions align', pkg.version === '1.27.0' && /Password-Encrypt Ver-1\.027/.test(main) && /Password-Encrypt Ver-1\.027/.test(db) && /my-passwords-v1\.027/.test(sw));
