...
check('Ver-1.009 app/server/package/service-worker versions align', pkg.version === '1.9.0' && /Password-Encrypt Ver-1\.009/.test(main) && /Password-Encrypt Ver-1\.009/.test(db) && /my-passwords-v1\.009/.test(sw));
