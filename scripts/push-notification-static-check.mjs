...
check('Ver-1.012 app/server/package/service-worker versions align', pkg.version === '1.12.0' && /Password-Encrypt Ver-1\.012/.test(main) && /Password-Encrypt Ver-1\.012/.test(db) && /my-passwords-v1\.012/.test(sw));
