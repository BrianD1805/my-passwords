...
check('Ver-1.011 app/server/package/service-worker versions align', pkg.version === '1.11.0' && /Password-Encrypt Ver-1\.011/.test(main) && /Password-Encrypt Ver-1\.011/.test(db) && /my-passwords-v1\.011/.test(sw));
