...
check('Ver-1.005.04 app/server/package/service-worker versions align', pkg.version === '1.5.4' && /Password-Encrypt Ver-1\.005\.04/.test(main) && /Password-Encrypt Ver-1\.005\.04/.test(db) && /my-passwords-v1\.005\.04/.test(sw));
