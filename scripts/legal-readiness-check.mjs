...
check('Ver-1.025 app/server/package/service-worker versions align', pkg.version === '1.25.0' && /Password-Encrypt Ver-1\.025/.test(main) && /Password-Encrypt Ver-1\.025/.test(server) && /my-passwords-v1\.025/.test(sw));
