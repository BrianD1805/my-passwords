...
check('Ver-1.021 app/server/package/service-worker versions align', pkg.version === '1.21.0' && /Password-Encrypt Ver-1\.021/.test(main) && /Password-Encrypt Ver-1\.021/.test(server) && /my-passwords-v1\.021/.test(sw));
