...
check('Ver-0.054F app/server/package/service-worker versions align', pkg.version === '0.0.54-f' && /Password-Encrypt Ver-0\.054F/.test(main) && /Password-Encrypt Ver-0\.054F/.test(server) && /my-passwords-v0\.054F/.test(sw));
