...
check('Ver-1.023 app/server/package/service-worker versions align', pkg.version === '1.23.0' && /Password-Encrypt Ver-1\.023/.test(main) && /Password-Encrypt Ver-1\.023/.test(server) && /my-passwords-v1\.023/.test(sw));
