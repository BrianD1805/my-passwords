...
check('Ver-0.054B app/server/package/service-worker versions align', pkg.version === '0.0.54-b' && /Password-Encrypt Ver-0\.054B/.test(main) && /Password-Encrypt Ver-0\.054B/.test(server) && /my-passwords-v0\.054B/.test(sw));
