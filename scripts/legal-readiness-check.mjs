...
check('Ver-0.054 app/server/package/service-worker versions align', pkg.version === '0.0.54' && /Password-Encrypt Ver-0\.054/.test(main) && /Password-Encrypt Ver-0\.054/.test(server) && /my-passwords-v0\.054/.test(sw));
