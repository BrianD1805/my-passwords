...
check('Ver-0.054A app/server/package/service-worker versions align', pkg.version === '0.0.54-a' && /Password-Encrypt Ver-0\.054A/.test(main) && /Password-Encrypt Ver-0\.054A/.test(server) && /my-passwords-v0\.054A/.test(sw));
