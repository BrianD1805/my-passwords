...
check('Ver-1.008 app/server/package/service-worker versions align', pkg.version === '1.8.0' && /Password-Encrypt Ver-1\.008/.test(main) && /Password-Encrypt Ver-1\.008/.test(server) && /my-passwords-v1\.008/.test(sw));
