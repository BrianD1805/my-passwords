...
check('Ver-1.005.05 app/server/package/service-worker versions align', pkg.version === '1.5.5' && /Password-Encrypt Ver-1\.005\.05/.test(main) && /Password-Encrypt Ver-1\.005\.05/.test(server) && /my-passwords-v1\.005\.05/.test(sw));
