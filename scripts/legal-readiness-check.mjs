...
check('Ver-1.026 app/server/package/service-worker versions align', pkg.version === '1.26.0' && /Password-Encrypt Ver-1\.026/.test(main) && /Password-Encrypt Ver-1\.026/.test(server) && /my-passwords-v1\.026/.test(sw));
