...
check('Ver-0.053D app/server/package/service-worker versions align', pkg.version === '0.0.53-d' && /Password-Encrypt Ver-0\.053D/.test(main) && /Password-Encrypt Ver-0\.053D/.test(server) && /my-passwords-v0\.053D/.test(sw));
