...
check('Ver-1.000 app/server/package/service-worker versions align', pkg.version === '1.0.0' && /Password-Encrypt Ver-1\.000/.test(main) && /Password-Encrypt Ver-1\.000/.test(server) && /my-passwords-v1\.000/.test(sw));
