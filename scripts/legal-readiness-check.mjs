...
check('Ver-0.053J app/server/package/service-worker versions align', pkg.version === '0.0.53-j' && /Password-Encrypt Ver-0\.053J/.test(main) && /Password-Encrypt Ver-0\.053J/.test(server) && /my-passwords-v0\.053J/.test(sw));
