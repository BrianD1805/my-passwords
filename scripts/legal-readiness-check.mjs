...
check('Ver-1.006 app/server/package/service-worker versions align', pkg.version === '1.6.0' && /Password-Encrypt Ver-1\.006/.test(main) && /Password-Encrypt Ver-1\.006/.test(server) && /my-passwords-v1\.006/.test(sw));
