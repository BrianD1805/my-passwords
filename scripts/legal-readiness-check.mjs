...
check('Ver-1.004 app/server/package/service-worker versions align', pkg.version === '1.4.0' && /Password-Encrypt Ver-1\.004/.test(main) && /Password-Encrypt Ver-1\.004/.test(server) && /my-passwords-v1\.004/.test(sw));
