...
check('Ver-1.002.02 app/server/package/service-worker versions align', pkg.version === '1.2.2' && /Password-Encrypt Ver-1\.002\.02/.test(main) && /Password-Encrypt Ver-1\.002\.02/.test(server) && /my-passwords-v1\.002\.02/.test(sw));
