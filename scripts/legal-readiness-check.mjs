...
check('Ver-0.054C app/server/package/service-worker versions align', pkg.version === '0.0.54-c' && /Password-Encrypt Ver-0\.054C/.test(main) && /Password-Encrypt Ver-0\.054C/.test(server) && /my-passwords-v0\.054C/.test(sw));
