...
check('Ver-1.014 app/server/package/service-worker versions align', pkg.version === '1.14.0' && /Password-Encrypt Ver-1\.014/.test(main) && /Password-Encrypt Ver-1\.014/.test(server) && /my-passwords-v1\.014/.test(sw));
