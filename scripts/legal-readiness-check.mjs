...
check('Ver-0.054G app/server/package/service-worker versions align', pkg.version === '0.0.54-g' && /Password-Encrypt Ver-0\.054G/.test(main) && /Password-Encrypt Ver-0\.054G/.test(server) && /my-passwords-v0\.054G/.test(sw));
