...
check('Ver-1.005.03 app/server/package/service-worker versions align', pkg.version === '1.5.3' && /Password-Encrypt Ver-1\.005\.03/.test(main) && /Password-Encrypt Ver-1\.005\.03/.test(server) && /my-passwords-v1\.005\.03/.test(sw));
