...
check('Ver-0.054H app/server/package/service-worker versions align', pkg.version === '0.0.54-h' && /Password-Encrypt Ver-0\.054H/.test(main) && /Password-Encrypt Ver-0\.054H/.test(server) && /my-passwords-v0\.054H/.test(sw));
