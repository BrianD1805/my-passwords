...
check('Ver-1.020 app/server/package/service-worker versions align', pkg.version === '1.20.0' && /Password-Encrypt Ver-1\.020/.test(main) && /Password-Encrypt Ver-1\.020/.test(server) && /my-passwords-v1\.020/.test(sw));
