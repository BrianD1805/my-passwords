...
check('Ver-1.007 app/server/package/service-worker versions align', pkg.version === '1.7.0' && /Password-Encrypt Ver-1\.007/.test(main) && /Password-Encrypt Ver-1\.007/.test(server) && /my-passwords-v1\.007/.test(sw));
