...
check('Ver-0.055D app/server/package/service-worker versions align', pkg.version === '0.0.55-d' && /Password-Encrypt Ver-0\.055D/.test(main) && /Password-Encrypt Ver-0\.055D/.test(server) && /my-passwords-v0\.055D/.test(sw));
