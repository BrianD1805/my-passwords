...
check('Ver-1.015 app/server/package/service-worker versions align', pkg.version === '1.15.0' && /Password-Encrypt Ver-1\.015/.test(main) && /Password-Encrypt Ver-1\.015/.test(server) && /my-passwords-v1\.015/.test(sw));
