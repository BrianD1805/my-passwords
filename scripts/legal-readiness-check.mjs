...
const claims = read('docs/ENCRYPTION_AND_CLAIMS_REGISTER_VER_0.052.md');
const processing = read('docs/DATA_PROCESSING_VER_0.052.md');
const commercial = read('docs/COMMERCIAL_LAUNCH_CHECKLIST_VER_0.052.md');
const support = read('docs/SUPPORT_PROCESS_VER_0.052.md');
...
check('Ver-0.052 app/server/package/service-worker versions align', pkg.version === '0.0.52' && /My Passwords Ver-0\.052/.test(main) && /My Passwords Ver-0\.052/.test(server) && /my-passwords-v0\.052/.test(sw));
...
console.log('\nAll 23 legal/commercial readiness checks passed.');
