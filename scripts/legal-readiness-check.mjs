...
check('Ver-1.010.02 app/server/package/service-worker versions align', pkg.version === '1.10.2' && /Password-Encrypt Ver-1\.010\.02/.test(main) && /Password-Encrypt Ver-1\.010\.02/.test(server) && /my-passwords-v1\.010\.02/.test(sw));
