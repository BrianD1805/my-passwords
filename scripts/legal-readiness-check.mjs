...
check('Ver-1.013 app/server/package/service-worker versions align', pkg.version === '1.13.0' && /Password-Encrypt Ver-1\.013/.test(main) && /Password-Encrypt Ver-1\.013/.test(server) && /my-passwords-v1\.013/.test(sw));
