...
check('Ver-0.053E app/server/package/service-worker versions align', pkg.version === '0.0.53-e' && /Password-Encrypt Ver-0\.053E/.test(main) && /Password-Encrypt Ver-0\.053E/.test(server) && /my-passwords-v0\.053E/.test(sw));
