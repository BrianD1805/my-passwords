...
check('Ver-1.016 app/server/package/service-worker versions align', pkg.version === '1.16.0' && /Password-Encrypt Ver-1\.016/.test(main) && /Password-Encrypt Ver-1\.016/.test(server) && /my-passwords-v1\.016/.test(sw));
