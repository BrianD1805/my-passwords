...
check('Ver-1.022 app/server/package/service-worker versions align', pkg.version === '1.22.0' && /Password-Encrypt Ver-1\.022/.test(main) && /Password-Encrypt Ver-1\.022/.test(server) && /my-passwords-v1\.022/.test(sw));
