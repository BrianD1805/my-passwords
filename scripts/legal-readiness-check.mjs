...
check('Ver-1.007.02 app/server/package/service-worker versions align', pkg.version === '1.7.2' && /Password-Encrypt Ver-1\.007\.02/.test(main) && /Password-Encrypt Ver-1\.007\.02/.test(server) && /my-passwords-v1\.007\.02/.test(sw));
