...
check('Ver-1.001 app/server/package/service-worker versions align', pkg.version === '1.1.0' && /Password-Encrypt Ver-1\.001/.test(main) && /Password-Encrypt Ver-1\.001/.test(server) && /my-passwords-v1\.001/.test(sw));
