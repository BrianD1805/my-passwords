...
check('Ver-0.054E app/server/package/service-worker versions align', pkg.version === '0.0.54-e' && /Password-Encrypt Ver-0\.054E/.test(main) && /Password-Encrypt Ver-0\.054E/.test(server) && /my-passwords-v0\.054E/.test(sw));
