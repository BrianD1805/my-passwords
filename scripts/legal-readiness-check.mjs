...
check('Ver-1.017 app/server/package/service-worker versions align', pkg.version === '1.17.0' && /Password-Encrypt Ver-1\.017/.test(main) && /Password-Encrypt Ver-1\.017/.test(server) && /my-passwords-v1\.017/.test(sw));
