...
check('Ver-0.055C app/server/package/service-worker versions align', pkg.version === '0.0.55-c' && /Password-Encrypt Ver-0\.055C/.test(main) && /Password-Encrypt Ver-0\.055C/.test(server) && /my-passwords-v0\.055C/.test(sw));
