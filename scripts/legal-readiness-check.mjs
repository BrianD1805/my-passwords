...
check('Ver-1.018 app/server/package/service-worker versions align', pkg.version === '1.18.0' && /Password-Encrypt Ver-1\.018/.test(main) && /Password-Encrypt Ver-1\.018/.test(server) && /my-passwords-v1\.018/.test(sw));
