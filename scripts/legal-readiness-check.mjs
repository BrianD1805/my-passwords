...
check('Ver-1.019 app/server/package/service-worker versions align', pkg.version === '1.19.0' && /Password-Encrypt Ver-1\.019/.test(main) && /Password-Encrypt Ver-1\.019/.test(server) && /my-passwords-v1\.019/.test(sw));
