...
check('Ver-0.054I app/server/package/service-worker versions align', pkg.version === '0.0.54-i' && /Password-Encrypt Ver-0\.054I/.test(main) && /Password-Encrypt Ver-0\.054I/.test(server) && /my-passwords-v0\.054I/.test(sw));
