...
check('Ver-1.005 app/server/package/service-worker versions align', pkg.version === '1.5.0' && /Password-Encrypt Ver-1\.005/.test(main) && /Password-Encrypt Ver-1\.005/.test(server) && /my-passwords-v1\.005/.test(sw));
