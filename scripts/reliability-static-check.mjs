...
check('Ver-1.001.02 version and cache are aligned', pkg.version === '1.1.2' && /Password-Encrypt Ver-1\.001\.02/.test(main) && /my-passwords-v1\.001\.02/.test(read('public/sw.js')));
