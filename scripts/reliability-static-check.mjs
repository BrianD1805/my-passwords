...
check('Ver-1.005.03 version and cache are aligned', pkg.version === '1.5.3' && /Password-Encrypt Ver-1\.005\.03/.test(main) && /my-passwords-v1\.005\.03/.test(read('public/sw.js')));
