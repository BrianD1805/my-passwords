...
check('Ver-1.009.01 version and cache are aligned', pkg.version === '1.9.1' && /Password-Encrypt Ver-1\.009\.01/.test(main) && /my-passwords-v1\.009\.01/.test(read('public/sw.js')));
