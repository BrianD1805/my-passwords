...
check('Ver-1.004.01 version and cache are aligned', pkg.version === '1.4.1' && /Password-Encrypt Ver-1\.004\.01/.test(main) && /my-passwords-v1\.004\.01/.test(read('public/sw.js')));
