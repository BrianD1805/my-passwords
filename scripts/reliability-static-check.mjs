...
check('Ver-1.011.01 version and cache are aligned', pkg.version === '1.11.1' && /Password-Encrypt Ver-1\.011\.01/.test(main) && /my-passwords-v1\.011\.01/.test(read('public/sw.js')));
