...
check('Ver-1.005.04 version and cache are aligned', pkg.version === '1.5.4' && /Password-Encrypt Ver-1\.005\.04/.test(main) && /my-passwords-v1\.005\.04/.test(read('public/sw.js')));
