...
check('Ver-1.005.02 version and cache are aligned', pkg.version === '1.5.2' && /Password-Encrypt Ver-1\.005\.02/.test(main) && /my-passwords-v1\.005\.02/.test(read('public/sw.js')));
