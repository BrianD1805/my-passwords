...
check('Ver-1.010.03 version and cache are aligned', pkg.version === '1.10.3' && /Password-Encrypt Ver-1\.010\.03/.test(main) && /my-passwords-v1\.010\.03/.test(read('public/sw.js')));
