...
check('Ver-1.010.01 version and cache are aligned', pkg.version === '1.10.1' && /Password-Encrypt Ver-1\.010\.01/.test(main) && /my-passwords-v1\.010\.01/.test(read('public/sw.js')));
