...
check('Ver-1.010.02 version and cache are aligned', pkg.version === '1.10.2' && /Password-Encrypt Ver-1\.010\.02/.test(main) && /my-passwords-v1\.010\.02/.test(read('public/sw.js')));
