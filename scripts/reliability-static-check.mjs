...
check('Ver-1.005.05 version and cache are aligned', pkg.version === '1.5.5' && /Password-Encrypt Ver-1\.005\.05/.test(main) && /my-passwords-v1\.005\.05/.test(read('public/sw.js')));
