...
check('Ver-1.001.01 version and cache are aligned', pkg.version === '1.1.1' && /Password-Encrypt Ver-1\.001\.01/.test(main) && /my-passwords-v1\.001\.01/.test(read('public/sw.js')));
