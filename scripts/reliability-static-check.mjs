...
check('Ver-1.005.01 version and cache are aligned', pkg.version === '1.5.1' && /Password-Encrypt Ver-1\.005\.01/.test(main) && /my-passwords-v1\.005\.01/.test(read('public/sw.js')));
