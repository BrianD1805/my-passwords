...
check('Ver-1.007.02 version and cache are aligned', pkg.version === '1.7.2' && /Password-Encrypt Ver-1\.007\.02/.test(main) && /my-passwords-v1\.007\.02/.test(read('public/sw.js')));
