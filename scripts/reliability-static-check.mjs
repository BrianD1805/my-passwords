...
check('Ver-1.020.01 version and cache are aligned', pkg.version === '1.20.1' && /Password-Encrypt Ver-1\.020\.01/.test(main) && /my-passwords-v1\.020\.01/.test(read('public/sw.js')));
