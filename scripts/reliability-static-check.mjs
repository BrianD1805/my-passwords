...
check('Ver-1.001.03 version and cache are aligned', pkg.version === '1.1.3' && /Password-Encrypt Ver-1\.001\.03/.test(main) && /my-passwords-v1\.001\.03/.test(read('public/sw.js')));
