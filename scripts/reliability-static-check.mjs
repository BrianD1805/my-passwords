...
check('Ver-1.013.01 version and cache are aligned', pkg.version === '1.13.1' && /Password-Encrypt Ver-1\.013\.01/.test(main) && /my-passwords-v1\.013\.01/.test(read('public/sw.js')));
