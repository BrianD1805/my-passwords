...
check('Ver-1.002.01 version and cache are aligned', pkg.version === '1.2.1' && /Password-Encrypt Ver-1\.002\.01/.test(main) && /my-passwords-v1\.002\.01/.test(read('public/sw.js')));
