...
check('Ver-1.007.01 version and cache are aligned', pkg.version === '1.7.1' && /Password-Encrypt Ver-1\.007\.01/.test(main) && /my-passwords-v1\.007\.01/.test(read('public/sw.js')));
