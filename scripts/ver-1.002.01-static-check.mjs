...
check('Ver-1.002.01 package and service-worker versions align', pkg.version === '1.2.1' && /Password-Encrypt Ver-1\.002\.01/.test(main) && /my-passwords-v1\.002\.01/.test(sw));
...
if (failed) {
  console.error(`\n${failed} Ver-1.002.01 feature check(s) failed; ${passed} passed.`);
  process.exit(1);
}
console.log(`\nAll ${passed} Ver-1.002.01 feature checks passed.`);
