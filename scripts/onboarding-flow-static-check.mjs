...
check('Ver-1.020.01 app/package/service-worker versions align', pkg.version === '1.20.1' && /Password-Encrypt Ver-1\.020\.01/.test(main) && /my-passwords-v1\.020\.01/.test(sw));
...
console.log(`\nAll Ver-1.020.01 onboarding static checks passed.`);
