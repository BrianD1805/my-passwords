...
check('Ver-1.019 app/package/service-worker versions align', pkg.version === '1.19.0' && /Password-Encrypt Ver-1\.019/.test(main) && /my-passwords-v1\.019/.test(sw));
...
console.log(`\nAll Ver-1.019 onboarding static checks passed.`);
