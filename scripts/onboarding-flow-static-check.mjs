...
check('Ver-1.022 app/package/service-worker versions align', pkg.version === '1.22.0' && /Password-Encrypt Ver-1\.022/.test(main) && /my-passwords-v1\.022/.test(sw));
...
console.log(`\nAll Ver-1.022 onboarding static checks passed.`);
