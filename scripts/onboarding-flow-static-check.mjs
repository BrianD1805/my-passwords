...
check('Ver-1.027 app/package/service-worker versions align', pkg.version === '1.27.0' && /Password-Encrypt Ver-1\.027/.test(main) && /my-passwords-v1\.027/.test(sw));
...
console.log(`\nAll Ver-1.027 onboarding static checks passed.`);
