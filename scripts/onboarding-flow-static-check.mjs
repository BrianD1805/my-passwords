...
check('Ver-1.018 app/package/service-worker versions align', pkg.version === '1.18.0' && /Password-Encrypt Ver-1\.018/.test(main) && /my-passwords-v1\.018/.test(sw));
...
console.log(`\nAll Ver-1.018 onboarding static checks passed.`);
