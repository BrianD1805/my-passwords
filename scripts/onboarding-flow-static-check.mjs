...
check('Ver-1.026 app/package/service-worker versions align', pkg.version === '1.26.0' && /Password-Encrypt Ver-1\.026/.test(main) && /my-passwords-v1\.026/.test(sw));
...
console.log(`\nAll Ver-1.026 onboarding static checks passed.`);
