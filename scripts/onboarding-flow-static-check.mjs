...
check('Ver-1.024.02 app/package/service-worker versions align', pkg.version === '1.24.2' && /Password-Encrypt Ver-1\.024/.test(main) && /my-passwords-v1\.024/.test(sw));
...
console.log(`\nAll Ver-1.024.02 onboarding static checks passed.`);
