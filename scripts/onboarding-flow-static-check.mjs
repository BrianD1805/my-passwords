...
check('Ver-1.012 app/package/service-worker versions align', pkg.version === '1.12.0' && /Password-Encrypt Ver-1\.012/.test(main) && /my-passwords-v1\.012/.test(sw));
...
console.log(`\nAll Ver-1.012 onboarding static checks passed.`);
