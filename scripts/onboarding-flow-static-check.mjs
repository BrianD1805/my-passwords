...
check('Ver-1.021 app/package/service-worker versions align', pkg.version === '1.21.0' && /Password-Encrypt Ver-1\.021/.test(main) && /my-passwords-v1\.021/.test(sw));
...
console.log(`\nAll Ver-1.021 onboarding static checks passed.`);
