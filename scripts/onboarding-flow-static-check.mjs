...
check('Ver-1.025 app/package/service-worker versions align', pkg.version === '1.25.0' && /Password-Encrypt Ver-1\.025/.test(main) && /my-passwords-v1\.025/.test(sw));
...
console.log(`\nAll Ver-1.025 onboarding static checks passed.`);
