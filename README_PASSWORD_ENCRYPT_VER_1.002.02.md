# Password-Encrypt Ver-1.002.02

## Mobile Emergency Package width fix
- Mobile release page now uses a white full-width layout with 5px outer left/right spacing.
- The release card/request content and released package viewer use 5px horizontal content spacing to maximise usable width on phones.
...
- App/server: Password-Encrypt Ver-1.002.02
- npm package: 1.2.2
- service-worker cache: my-passwords-v1.002.02
...
- Ver-1.002.02 feature checks: 17/17 PASS
