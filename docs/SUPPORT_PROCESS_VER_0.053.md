# Password-Encrypt Ver-0.053 — Customer Support Process
...
No public response-time/SLA is promised by Ver-0.053. Support should acknowledge and triage requests reasonably promptly, with security, billing and privacy issues prioritised over general questions.
