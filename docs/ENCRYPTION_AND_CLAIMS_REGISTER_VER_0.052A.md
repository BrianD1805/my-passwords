# My Passwords Ver-0.052A — Encryption & Marketing Claims Register
...
- My Passwords does not intentionally send or store the master password on its servers.
...
- “My Passwords does not intentionally send or store your master password on its servers.”
...
> “My Passwords does not hold the server-side master password normally needed to decrypt stored vault snapshots, so routine server/admin systems cannot normally read them.”
