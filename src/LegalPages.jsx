...
function TermsPage({ embedded = false }) {
  return (
    <LegalShell
      ...
      intro="These Terms explain the rules for using Password-Encrypt, including account access, encrypted vault services, subscriptions and Emergency Access. Mandatory consumer rights that apply where you live are not excluded by these Terms."
      embedded={embedded}
    >
