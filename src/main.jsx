...
const VERSION = 'My Passwords Ver-0.002E';
...
const starterItems = [
  ...
  },
  {
    ...
    payload: {
      ...
      notes: 'Future emergency access will use waiting periods, roles and audit logs. Ver-0.002E prepares the tenant/user database foundation.'
    },
    updatedAt: new Date().toISOString()
  }
];
...
function App() {
  ...
  async function unlockVault(event) {
    ...
    try {
      ...
      if (existing) {
        setItems(existing);
        setMessage('Vault unlocked. Ver-0.002E can now push encrypted snapshots to the database once configured.');
      } else {
    ...
    return (
      <main className="lock-screen">
        <section className="lock-card">
          ...
          <h1>My Passwords</h1>
          <p className="intro">Unlock your local encrypted vault. Ver-0.002E adds database connection checks, admin tenant bootstrap and encrypted snapshot sync.</p>
    ...
    <main className="app-shell">
      ...
      <section className="sync-panel">
        <div className="sync-title">
          <div><p className="eyebrow">Ver-0.002E database foundation</p><h2><Cloud size={21} /> Encrypted sync setup</h2></div>
