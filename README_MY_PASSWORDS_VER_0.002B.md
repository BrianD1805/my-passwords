# My Passwords Ver-0.002B — Netlify Database Helper & Migration Fix
...
- Bumped visible app/function version to `My Passwords Ver-0.002B`.
- Bumped service worker cache to `my-passwords-v0.002B`.
...
git status
git add .
git commit -m "My Passwords Ver-0.002B use Netlify Database helper and migration"
...
```json
{
  ...
  "connected": true,
  "app": "My Passwords",
  "version": "My Passwords Ver-0.002B",
