# My Passwords Ver-0.002F — Netlify Database Helper & Migration Fix
...
- Bumped visible app/function version to `My Passwords Ver-0.002F`.
- Bumped service worker cache to `my-passwords-v0.002F`.
...
git status
git add .
git commit -m "My Passwords Ver-0.002F use Netlify Database helper and migration"
...
```json
{
  ...
  "connected": true,
  "app": "My Passwords",
  "version": "My Passwords Ver-0.002F",
