# My Passwords Ver-0.002G — Netlify Database Helper & Migration Fix
...
- Bumped visible app/function version to `My Passwords Ver-0.002G`.
...
git status
git add .
git commit -m "My Passwords Ver-0.002G use Netlify Database helper and migration"
